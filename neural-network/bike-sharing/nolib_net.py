...
class NeuralNetwork(object):
    ...
    def backprop(self, outputs, hidden_outputs, y, X, delta_weights_h_o, delta_weights_i_h):
        ...
        hidden_error_terms = hidden_error * hidden_outputs * (1 - hidden_outputs)
...
def main(features, targets, test_features, test_targets, scaled_features):
    ...
    for ii in range(iterations):
        ...
        train_loss = mse_loss(network.forward(features)[0].T, targets['cnt'].values)
        val_loss = mse_loss(network.forward(test_features)[0].T, test_targets['cnt'].values)
...
if __name__ == '__main__':
    ...
    losses, predictions = main(features, targets, test_features, test_targets, scaled_features)
